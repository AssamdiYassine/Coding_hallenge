...
export default class PaginationBoxView extends Component {
  ...
  render() {
    ...
    let to = (selected + 1) * pageLimit

    return (
      <div className="mt-5 row">
        <div className="col-8 my-auto">
          <ul className={className || containerClassName + ' m-0'}>
            ...
            <li className={nextClasses}>
		  	...
		  	<div className="col-1 text-right my-auto text-muted">
          <select className="form-control form-control-solid form-control-sm pagination-select ml-auto my-auto mx-auto" disabled>
        ...
        <div className="col-3 text-right my-auto text-muted">
          <span className="my-auto">
            Affiche {selected * pageLimit}-{to > totalRecords ? totalRecords : to} de {totalRecords}
          </span>
        </div>
      </div>
    );
